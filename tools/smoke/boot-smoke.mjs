...
// @mention picker — same serve-or-the-harness-aborts-it rule as every other
// extracted module. Unlisted, the composer boots without it and any assertion
// about mentions would quietly pass by testing nothing.
const MENTION_AC_JS = readFileSync(resolve(REPO_ROOT, 'static', 'js', 'mention-autocomplete.js'), 'utf8');
...
const POINTER_DRAG_JS = readFileSync(resolve(REPO_ROOT, 'static', 'js', 'pointer-drag.js'), 'utf8');
...
const STATIC_MAP = {
  ...
  '/static/js/mention-autocomplete.js': ['text/javascript; charset=utf-8', MENTION_AC_JS],
  ...
  '/static/js/pointer-drag.js': ['text/javascript; charset=utf-8', POINTER_DRAG_JS],
