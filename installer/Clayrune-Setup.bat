...
echo   https://raw.githubusercontent.com/clayrune-io/clayrune/master/installer/install-prompt.md
echo.
pause
...
powershell.exe -ExecutionPolicy Bypass -NoProfile -Command "$cb = [DateTimeOffset]::Now.ToUnixTimeSeconds(); iwr \"https://raw.githubusercontent.com/clayrune-io/clayrune/master/installer/install.ps1?t=$cb\" -useb | iex"
