...
- **Repository**: `https://github.com/clayrune-io/clayrune.git`
...
5. Print: `If the problem persists, open an issue at https://github.com/clayrune-io/clayrune/issues with the log.`
