...
def _recent_claude_transcripts(project_path, limit=5, must_include_csids=None,
    ...
    `exclude_transforms`: skip Scribe/condense/Distiller transform transcripts
    before the cut, for lists a human or an agent reads as "conversations".
    """
